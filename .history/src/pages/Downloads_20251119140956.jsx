  ...
  return (
    <main className="container mx-auto px-6 py-12">
      ...
      <section className="mt-10 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <a href="/downloads/industrial-gaskets.pdf" className="block rounded-xl border border-slate-700/60 bg-slate-800/40 p-6 hover:bg-slate-800/60">
        ...
        <a href="/downloads/valves-strainers.pdf" className="block rounded-xl border border-slate-700/60 bg-slate-800/40 p-6 hover:bg-slate-800/60">
        ...
        <a href="/downloads/lubricants.pdf" className="block rounded-xl border border-slate-700/60 bg-slate-800/40 p-6 hover:bg-slate-800/60">
        ...
        <a href="/downloads/machines-tools.pdf" className="block rounded-xl border border-slate-700/60 bg-slate-800/40 p-6 hover:bg-slate-800/60">
        ...
        <a href="/downloads/company-overview.pdf" className="block rounded-xl border border-slate-700/60 bg-slate-800/40 p-6 hover:bg-slate-800/60">
